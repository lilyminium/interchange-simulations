...
def main(
    ...
    output_subdirectory = f"ne-{n_equilibration_steps}_np-{n_production_steps}_dt-{timestep}_nb-{n_barostat_steps}-omm-int-gpu_omm-810"
    ...
    interchange.to_pdb(input_directory / f"{output_subdirectory}-omm-810.pdb")
